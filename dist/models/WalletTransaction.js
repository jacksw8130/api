...
const WalletTransactionSchema = new mongoose.Schema({
    ...
    mode: { type: String, required: true, enum: ['transfer', 'withdraw', 'bidding'] },
    ...
    ticket_id: { type: mongoose.Types.ObjectId, refPath: 'ticket_type', required: false },
    ticket_type: { type: String, enum: ['tickets', 'ticket_candidates'], required: false },
